...
public class OAuthLogoutHandler implements LogoutHandler {
    ...
    @Autowired
    private AuthenticationManager authenticationManager;      // 사용자의 인증을 확인하고, 사용자가 제공한 자격 증명(예: 사용자 이름과 비밀번호, JWT 토큰 등)이 올바른지 검증하는 인터페이스
...
//                    authentication = getUsernamePasswordAuthenticationToken(token);
//                    SecurityContextHolder.getContext().setAuthentication(authentication);
//                    System.out.println("[OAUTHLOGOUTHANDLER's JWTAUTHORIZATIONFILTER] : " + authentication);
//                }
//
//
...
//        System.out.println("[OAUTHLOGOUTHANDLER] getUsernamePasswordAuthenticationToken...authenticationToken : " +authentication );
//        if(user!=null)
//        {
