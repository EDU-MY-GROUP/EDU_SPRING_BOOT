        ...
        if (token != null) {
            try {
                if(jwtTokenProvider.validateToken(token)) {
                    ...
                    System.out.println("JwtAuthorizationFilter.doFilterInternal...authentication : " + authentication);
                }
            } catch (ExpiredJwtException e)
            {

                System.out.println("JwtAuthorizationFilter.doFilterInternal...ExpiredJwtException ...."+e.getMessage());
